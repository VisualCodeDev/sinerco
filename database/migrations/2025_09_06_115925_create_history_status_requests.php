...
return new class extends Migration
{
    ...
    {
        Schema::create('history_status_requests', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->timestamp('trashed_at')->useCurrent(); // new column for history
    ...
    {
        Schema::dropIfExists('history_status_requests');
    }
};
